...
<template>
  <alert
    title="Управляйте страницей НКО"
    description="Здесь вы можете редактировать страницу вашего НКО на сайте “воБлаго”.
    Меняйте описание, добавляйте фото и видео. Люди будут рады узнать о вас как можно больше!"
  ></alert>
  <alert
    v-if="getBidStatus('fundbid', 'REJECTED')"
    class="alert_error"
