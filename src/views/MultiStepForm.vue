<template>
  <div>
    ...
    <p>
      ...
      next/previous controls and validation before moving to the next step. There are
      infinite ways you could implement this, this is just one of them. You could throw in
      a form generator to make this even easier.
    </p>
